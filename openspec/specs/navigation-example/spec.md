...
Defines the standalone `example/` app shipped with `vm_navigation`, demonstrating
route registration, guards, redirect, and the navigator service end to end, including
optional `vm_storyboard` integration for transitions/theme.
