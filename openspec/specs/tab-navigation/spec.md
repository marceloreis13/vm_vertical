...
Define `VmTabBarCubit`: tab selection delegating to the navigation shell, index reconciliation, state preservation across switches, and reactive per-tab badges.
