...
Defines the reusable widget library `vm_storyboard` ships (button, inputs, cards, feedback,
states, dialog...), consuming only the module's own tokens/theme and no app-specific
knowledge.
