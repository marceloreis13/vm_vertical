...
Defines how modules declare and expose their own routes in `vm_navigation`, and how
an app aggregates route lists from every activated module into a single `GoRouter`
without any module referencing another module's routes.
