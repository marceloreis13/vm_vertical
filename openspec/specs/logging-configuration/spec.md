...
Define how the consuming app configures and registers the logging module (sinks, levels, sensitive keys, redactors) via DI, and the standalone example that demonstrates it.
