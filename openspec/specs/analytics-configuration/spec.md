...
Define how the consuming app configures and registers the analytics module (providers, keys, screen-tracking toggle) via DI, and the standalone example that demonstrates it.
