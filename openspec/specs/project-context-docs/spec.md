...
Defines the living documentation base under `docs/` that describes available modules, how each is used, and how to inject its configuration, kept in sync as new modules are created.
